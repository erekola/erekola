...
turva.dev is my own reference build. It scores 100/100, Level 5 (Agent-Native), on isitagentready.com, Cloudflare's agent-readiness scanner, measured 2026-08-20. Its own web security is published on the same principle: Hardenize passes all 24 categories and Internet.nl reads 98/100, the one deduction being a single HTTPS sub-test I document rather than hide.
