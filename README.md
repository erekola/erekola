...
**turva.dev, my own reference build, is ranked #1 of publicly-scanned sites on the startuphub.ai agent-readiness leaderboard, scoring 100/100 (A+) across all six categories. On the Cloudflare Agent-Ready scanner it scores 100/100 at Level 5 (Agent-Native). Measured 2026-07-01.**
...
The Cloudflare Worker that produces these results is open source: [turva-worker](https://github.com/busygoat/turva-worker). You can read every line before you hire me.
...
A consolidated agent-readiness reference, with a short definition of each surface agents read and a link to its full guide, is in the open-source repository: [docs/agent-readiness.md](https://github.com/busygoat/turva-worker/blob/main/docs/agent-readiness.md).
